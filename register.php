              ...
              <div class="p-5">
                ...
                <form method="post" class="user">
                  <div class="form-group row">
                    <div class="  mb-sm-0">
                      <input type="hidden" name="id" class="form-control form-control-user" id="exampleFirstName" placeholder="id" />
                    </div>
                  ...
                  <button class="btn btn-primary btn-user btn-block submit" type="submit" name="submit">Register</button>
                  <hr />
                </form>
                <hr />
                <div class="text-center">
